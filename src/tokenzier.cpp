...
TokenPattern patterns[] = {
	...
	{TOKEN_TYPE_IDENTIFIER            , std::regex("^[a-zA-Z_][a-zA-Z0-9_]*")},
	...
	{TOKEN_TYPE_OPEN_BRACE            , std::regex("^\\{") 			         },
	{TOKEN_TYPE_CLOSE_BRACE           , std::regex("^\\}") 			         },
	{TOKEN_TYPE_SEMICOLON             , std::regex("^;")                     },
	{TOKEN_TYPE_COLON                 , std::regex("^:")                     },
	{TOKEN_TYPE_COMMA                 , std::regex("^,")                     },
	{TOKEN_TYPE_ASSIGN                , std::regex("^=")                     },
};
// clang-format on
